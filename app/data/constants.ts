...
export const BRANCHES: Branch[] = [
  {
    ...
    offers: [
      { title: 'Monthly Plan', originalPrice: '7,000', price: '5,000', perks: 'Flexible Month-to-Month Membership', category: 'gym' },
      { title: 'Quarterly Plan', originalPrice: '14,000', price: '10,000', perks: '1 Month Ext. FREE + 15 Days Freezing', category: 'gym' },
      { title: 'Half-Yearly Plan', originalPrice: '21,000', price: '15,000', perks: '1 Month Ext. FREE + 30 Days Freezing', category: 'gym' },
      { title: 'Yearly Plan', originalPrice: '28,000', price: '20,000', perks: '2 Months Ext. FREE + 45 Days Freezing', popular: true, category: 'gym' },
      { title: 'PT Level 1', originalPrice: '20,000', price: '15,000', perks: 'Beginner Program + Form Coaching', category: 'pt' },
      { title: 'PT Level 2', originalPrice: '24,000', price: '18,000', perks: 'Intermediate Program + Custom Nutrition Plan', category: 'pt' },
      { title: 'PT Level 3', originalPrice: '27,000', price: '20,000', perks: 'Elite Program + Full Transformation Package', popular: true, category: 'pt' },
    ]
  },
  {
    id: 'kannamangala',
  ...
  },
  {
    ...
    offers: [
      { title: 'Monthly Plan', originalPrice: '4,500', price: '3,000', perks: 'Flexible Month-to-Month Membership', category: 'gym' },
      { title: 'Quarterly Plan', originalPrice: '14,000', price: '10,000', perks: '1 Month Ext. FREE + 15 Days Freezing', category: 'gym' },
      { title: 'Half-Yearly Plan', originalPrice: '17,000', price: '12,000', perks: '1 Month Ext. FREE + 30 Days Freezing', category: 'gym' },
      { title: 'Yearly Plan', originalPrice: '21,000', price: '15,000', perks: '2 Months Ext. FREE + 45 Days Freezing', popular: true, category: 'gym' },
      { title: 'PT Level 1', originalPrice: '12,000', price: '8,000', perks: 'Beginner Program + Form Coaching', category: 'pt' },
      { title: 'PT Level 2', originalPrice: '16,000', price: '12,000', perks: 'Intermediate Program + Custom Nutrition Plan', category: 'pt' },
      { title: 'PT Level 3', originalPrice: '18,000', price: '14,000', perks: 'Elite Program + Full Transformation Package', popular: true, category: 'pt' },
    ]
  },
  {
    id: 'yello',
  ...
  },
  {
    ...
    offers: [
      { title: 'Monthly Plan', originalPrice: '4,000', price: '2,500', perks: 'Flexible Month-to-Month Membership', category: 'gym' },
      { title: 'Quarterly Plan', originalPrice: '9,000', price: '6,000', perks: '1 Month Ext. FREE + 15 Days Freezing', category: 'gym' },
      { title: 'Half-Yearly Plan', originalPrice: '12,000', price: '8,000', perks: '1 Month Ext. FREE + 30 Days Freezing', category: 'gym' },
      { title: 'Yearly Plan', originalPrice: '14,000', price: '10,000', perks: '2 Months Ext. FREE + 45 Days Freezing', popular: true, category: 'gym' },
      { title: 'PT Level 1', originalPrice: '9,000', price: '6,000', perks: 'Beginner Program + Form Coaching', category: 'pt' },
      { title: 'PT Level 2', originalPrice: '11,000', price: '8,000', perks: 'Intermediate Program + Custom Nutrition Plan', category: 'pt' },
      { title: 'PT Level 3', originalPrice: '13,000', price: '10,000', perks: 'Elite Program + Full Transformation Package', popular: true, category: 'pt' },
    ]
  }
];
